...
@Component({
  ...
  // Không khai MatDialogModule ở đây: template không dùng directive mat-dialog-*
  // nào, dialog mở bằng service. Khai thừa sẽ tạo một MatDialog riêng trong
  // injector của cây component này, lấn át provider mà test bơm vào.
