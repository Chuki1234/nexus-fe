...
@Component({
  selector: 'app-manage-accounts-modal',
  standalone: true,
  imports: [
    CommonModule,
    MatButtonModule,
  ...
  templateUrl: './manage-accounts-modal.html',
  styleUrl: './manage-accounts-modal.css',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ManageAccountsModal {
  readonly dialogRef = inject(MatDialogRef<ManageAccountsModal>);
